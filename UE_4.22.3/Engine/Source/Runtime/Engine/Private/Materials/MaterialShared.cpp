	...
	) const
{
	...
	switch(GetShadingModel())
	{
		...
		case MSM_MastersOne:		OutEnvironment.SetDefine(TEXT("MATERIAL_SHADINGMODEL_MASTERS_ONE"),			TEXT("1")); break;
		case MSM_MastersTwo:		OutEnvironment.SetDefine(TEXT("MATERIAL_SHADINGMODEL_MASTERS_TWO"),			TEXT("1")); break;
		case MSM_MastersThree:		OutEnvironment.SetDefine(TEXT("MATERIAL_SHADINGMODEL_MASTERS_THREE"),		TEXT("1")); break;
		default:
